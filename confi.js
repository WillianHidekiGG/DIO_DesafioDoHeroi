...
function fimAventura(){
    ...
    document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[0];
    document.getElementById("pontosFinais").innerHTML ="SCORE: " + pontuacao;
    if(pontuacao <= 1000){
        document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[0];
        document.getElementById("pontosFinais").innerHTML ="SCORE: " + pontuacao;
           }else if(pontuacao <= 2000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[1];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao <= 5000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[2];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao <= 7000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[3];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao <= 8000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[4];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao <= 9000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[5];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao <= 10000){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[6];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else if(pontuacao >= 10001){
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[7];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
           }else{
               document.getElementById("classificacaoFinal").innerHTML = "NIVEL DO SEU HERÓI É: "  + classificacoes[0];
               document.getElementById("pontosFinais").innerHTML = "SCORE: " + pontuacao;
